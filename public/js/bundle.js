    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: "/api/v1/books/".concat(data.bookId, "/comments/").concat(data.commentId)
            };

            if (reqType === 'POST') {
              axiosOptions = {
                url: "/api/v1/books/".concat(data.bookId, "/comments")
              };
              delete data.bookId;
              axiosOptions.data = data;
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (routeType !== 'Delete') {
              axiosOptions = {
                url: "/api/v1/users/userUpdate".concat(routeType),
                method: reqType,
                data: data
              };
            }

            spinnerEl = "#settings-".concat(routeType === 'Password' ? 'password' : 'details', "-form__loading-spinner");
...
var userButton = document.querySelector('#main-nav__user-button');
