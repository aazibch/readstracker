        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://localhost:3000/api/v1/users/".concat(routeType),
              data: data
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: reqType === 'POST' ? 'http://localhost:3000/api/v1/books/' : "http://localhost:3000/api/v1/books/".concat(data.id)
            };
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"manageCommentsData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.manageCommentsData = exports.addCommentEl = exports.removeCommentEl = exports.commentDeleteClickHandler = void 0;
...
var commentDeleteClickHandler = function commentDeleteClickHandler(e) {
  var bookId = document.querySelector('#full-book').getAttribute('data-id');
  var commentId = e.target.getAttribute('data-id');
  (0, _deleteConfirmationModal.prepareConfirmationModal)('comment', commentId);
  (0, _deleteConfirmationModal.displayConfirmationModal)('Are you sure you want to delete this comment?');
};

exports.commentDeleteClickHandler = commentDeleteClickHandler;

var removeCommentEl = function removeCommentEl(commentId) {
  var commentEl = document.querySelector("#comment-".concat(commentId));
  commentEl.remove();
};

exports.removeCommentEl = removeCommentEl;

var addCommentEl = function addCommentEl(comment) {
  var commentDate = new Date(comment.dateCreated).toLocaleString('en-us', {
    year: 'numeric',
    month: 'short',
    day: '2-digit',
    hour: '2-digit',
  ...
  document.querySelector('#full-book__comments').insertAdjacentHTML('beforeend', "<div id='comment-".concat(comment._id, "' class='full-book__comment'>\n            <div class='full-book__comment-content-1'>\n                <p class='full-book__comment-body'>").concat(comment.comment, "</p>\n                <button class='book-card__button full-book__comment-delete-button' data-id=").concat(comment._id, "> &#10005; </button>\n            </div>\n            <div class='full-book__comment-content-2'>\n                <p class='full-book__comment-date'>").concat(commentDate, "</p>\n            </div>\n        </div>"));
  document.querySelector("#comment-".concat(comment._id)).addEventListener('click', commentDeleteClickHandler);
};

exports.addCommentEl = addCommentEl;
var manageCommentsData = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reqType, data) {
    var axiosOptions, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: "http://localhost:3000/api/v1/books/".concat(data.bookId, "/comments/").concat(data.commentId)
            };

            if (reqType === 'POST') {
              axiosOptions = {
                url: "http://localhost:3000/api/v1/books/".concat(data.bookId, "/comments")
              };
              delete data.bookId;
              axiosOptions.data = data;
            }
          ...
          case 5:
            ...
            if (reqType === 'DELETE') {
              if (response.status === 204) {
                (0, _alerts.displayAlert)('success', 'Comment successfully deleted!');
                removeCommentEl(data.commentId);
              }
            } else if (reqType === 'POST') {
              if (response.status === 201) {
                document.querySelector('#full-book__new-comment-body').value = '';
                (0, _alerts.displayAlert)('success', 'Comment successfully posted!');
...
exports.manageCommentsData = manageCommentsData;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (routeType !== 'Delete') {
              axiosOptions = {
                url: "http://localhost:3000/api/v1/users/userUpdate".concat(routeType),
                method: reqType,
                data: data
              };
            }

            spinnerEl = "#settings-".concat(routeType === 'Password' ? 'password' : 'details', "-form_loading-spinner");
...
var _manageCommentsData = require("./manageCommentsData");
  ...
  if (selectedEl.tagName === 'BUTTON') {
    if (selectedEl.getAttribute('data-value') === 'true') {
      ...
      if (target === 'book') {
        ...
        var commentId = modalEl.getAttribute('data-comment');
        (0, _manageCommentsData.manageCommentsData)('DELETE', {
          bookId: bookId,
          commentId: commentId
        });
      }
...
var prepareConfirmationModal = function prepareConfirmationModal(target, commentId) {
  var modalEl = document.querySelector('#confirmation-modal');
...
},{"./manageBookData":"manageBookData.js","./manageCommentsData":"manageCommentsData.js","./manageUserData":"manageUserData.js"}],"managePasswordRecovery.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: "http://localhost:3000/api/v1/users/".concat(routeType, "Password/")
            };
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.querySelector('#signup-form__name-field').value;
...
if (settingsDetailsForm) {
  settingsDetailsForm.addEventListener('submit', function (e) {
    ...
    (0, _manageUserData.manageUserData)('Data', 'PATCH', formData);
  });
}
...
if (settingsPasswordForm) {
  settingsPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _manageUserData.manageUserData)('Password', 'PATCH', {
...
if (userDropdownButton) {
  userDropdownButton.addEventListener('click', function (e) {
    var dropdownEl = document.querySelector('#main-nav__dropdown');
...
if (bookForm) {
  bookForm.addEventListener('submit', function (e) {
    ...
    console.log('thislog', title, author, rating, genre);
...
var attachListenerToCommentDeleteButtons = function attachListenerToCommentDeleteButtons(handler) {
  var commentDeleteButtons = document.querySelectorAll('.full-book__comment-delete-button');
  commentDeleteButtons.forEach(function (el) {
    el.addEventListener('click', handler);
  });
};

if (fullBook) {
  document.querySelector('#full-book__dropdown-button').addEventListener('click', function (e) {
  ...
  attachListenerToCommentDeleteButtons(_manageCommentsData.commentDeleteClickHandler);
  document.querySelector('#full-book__comment-form').addEventListener('submit', function (e) {
    e.preventDefault();
    var comment = document.querySelector('#full-book__new-comment-body').value;
    var bookId = document.querySelector('#full-book').getAttribute('data-id');
    (0, _manageCommentsData.manageCommentsData)('POST', {
      comment: comment,
      bookId: bookId
    });
  });
} // End of book page
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./signupOrLogin":"signupOrLogin.js","./ratingInput":"ratingInput.js","./deleteConfirmationModal":"deleteConfirmationModal.js","./manageBookData":"manageBookData.js","./manageCommentsData":"manageCommentsData.js","./manageUserData":"manageUserData.js","./managePasswordRecovery":"managePasswordRecovery.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
