...
},{"outlayer":"../../node_modules/outlayer/outlayer.js","get-size":"../../node_modules/get-size/get-size.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.displayAlert = exports.hideAlert = void 0;
...
var displayAlert = function displayAlert(type, message) {
  document.querySelector('#alert').innerHTML = "<p class=\"alert__content alert__content--".concat(type, "\">").concat(message, "</p>");
  setTimeout(hideAlert, 2500);
};

exports.displayAlert = displayAlert;
},{}],"catchAsync.js":[function(require,module,exports) {
"use strict";
...
var catchAsync = function catchAsync(method) {
  return function () {
    method.apply(void 0, arguments).catch(function (err) {
      var spinnerElements = document.querySelectorAll('.loading-spinner');

      var _iterator = _createForOfIteratorHelper(spinnerElements),
          _step;
      ...
      if (err.response.data.message) {
        ...
        (0, _alerts.displayAlert)('error', 'Something went wrong.');
      }
    });
  };
};
...
},{"./alerts":"alerts.js"}],"signupOrLogin.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.logout = exports.signupOrLogin = void 0;
...
var signupOrLogin = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(routeType, data) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector("".concat(routeType === 'login' ? '#login-form' : '#signup-form', "__loading-spinner")).style.display = 'inline-block';
            _context.next = 3;
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/".concat(routeType),
              data: data
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.displayAlert)('error', 'Something went wrong. Try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"ratingInput.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ratingClickHandler = exports.ratingMouseLeaveHandler = exports.ratingMouseOverHandler = exports.clearHighlightFromElements = exports.highlightElements = exports.getIndexOfSelectedElement = void 0;
var starsContainerElement = document.querySelector('#form__stars');
var starElements;
...
var selectedStarEl = document.querySelector('.form__star--selected');
...
var getIndexOfSelectedElement = function getIndexOfSelectedElement() {
  return +document.querySelector('.form__star--selected').getAttribute('data-index');
};

exports.getIndexOfSelectedElement = getIndexOfSelectedElement;

var highlightElements = function highlightElements(startIndex, endIndex) {
  var start = !startIndex ? 0 : startIndex;
  var end = !endIndex ? starElements.length : endIndex;
...
var clearHighlightFromElements = function clearHighlightFromElements(startIndex, endIndex) {
  var start = !startIndex ? 0 : startIndex;
  var end = !endIndex ? starElements.length : endIndex;
...
exports.clearHighlightFromElements = clearHighlightFromElements;

var ratingMouseOverHandler = function ratingMouseOverHandler(e) {
  if (e.target.classList.contains('fa-star')) {
    var starIndex = +e.target.getAttribute('data-index');
    highlightElements(0, starIndex + 1);
    clearHighlightFromElements(starIndex + 1);
  }
};

exports.ratingMouseOverHandler = ratingMouseOverHandler;

var ratingMouseLeaveHandler = function ratingMouseLeaveHandler(e) {
  clearHighlightFromElements();

  if (ratingSelected) {
    var selectedIndex = getIndexOfSelectedElement();
    highlightElements(0, selectedIndex + 1);
  }
};

exports.ratingMouseLeaveHandler = ratingMouseLeaveHandler;

var ratingClickHandler = function ratingClickHandler(e) {
  if (ratingSelected) {
    clearHighlightFromElements();
...
exports.ratingClickHandler = ratingClickHandler;
},{}],"manageBookData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.manageBookData = void 0;
...
var manageBookData = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reqType, data) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: reqType === 'POST' ? '/api/v1/books/' : "/api/v1/books/".concat(data.id)
            };
            ...
            document.querySelector("#".concat(reqType === 'POST' ? 'book-form' : 'edit-book-form', "__loading-spinner")).style.display = 'inline-block';
          ...
          case 7:
            ...
            if (reqType === 'DELETE') {
              if (response.status === 204) {
                (0, _alerts.displayAlert)('success', 'Book successfully deleted!');
                setTimeout(function () {
              ...
              if (response.status === 200) {
                (0, _alerts.displayAlert)('success', 'Book successfully updated!');
                setTimeout(function () {
                  location.assign("/books/".concat(response.data.data._id));
                }, 1500);
              }
            } else if (reqType === 'POST') {
              if (response.status === 201) {
                (0, _alerts.displayAlert)('success', 'Book successfully posted!');
                setTimeout(function () {
...
exports.manageBookData = manageBookData;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"manageNotesData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.manageNotesData = exports.addNoteEl = exports.removeNoteEl = exports.noteDeleteClickHandler = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _alerts = require("./alerts");

var _deleteConfirmationModal = require("./deleteConfirmationModal");
...
var noteDeleteClickHandler = function noteDeleteClickHandler(e) {
  var bookId = document.querySelector('#full-book').getAttribute('data-id');
  var noteId = e.target.getAttribute('data-id');
  (0, _deleteConfirmationModal.prepareConfirmationModal)('note', noteId);
  (0, _deleteConfirmationModal.displayConfirmationModal)('Are you sure you want to delete this note?');
};

exports.noteDeleteClickHandler = noteDeleteClickHandler;

var removeNoteEl = function removeNoteEl(noteId) {
  var noteEl = document.querySelector("#note-".concat(noteId));
  noteEl.remove();
};

exports.removeNoteEl = removeNoteEl;

var addNoteEl = function addNoteEl(note) {
  var noteDate = new Date(note.dateCreated).toLocaleString('en-us', {
    year: 'numeric',
    month: 'short',
    day: '2-digit',
    hour: '2-digit',
  ...
  document.querySelector('#full-book__notes').insertAdjacentHTML('beforeend', "<div id='note-".concat(note._id, "' class='full-book__note'>\n            <div class='full-book__note-content-1'>\n                <p class='full-book__note-body'>").concat(note.note, "</p>\n                <button class='book-card__button full-book__note-delete-button' data-id=").concat(note._id, "> &#10005; </button>\n            </div>\n            <div class='full-book__note-content-2'>\n                <p class='full-book__note-date'>").concat(noteDate, "</p>\n            </div>\n        </div>"));
  document.querySelector("#note-".concat(note._id)).addEventListener('click', noteDeleteClickHandler);
};

exports.addNoteEl = addNoteEl;
var manageNotesData = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reqType, data) {
    var axiosOptions, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: "/api/v1/books/".concat(data.bookId, "/notes/").concat(data.noteId)
            };

            if (reqType === 'POST') {
              axiosOptions = {
                url: "/api/v1/books/".concat(data.bookId, "/notes")
              };
              delete data.bookId;
              axiosOptions.data = data;
            }
          ...
          case 5:
            ...
            if (reqType === 'DELETE') {
              if (response.status === 204) {
                (0, _alerts.displayAlert)('success', 'Note successfully deleted!');
                removeNoteEl(data.noteId);
              }
            } else if (reqType === 'POST') {
              if (response.status === 201) {
                document.querySelector('#full-book__new-note-body').value = '';
                (0, _alerts.displayAlert)('success', 'Note successfully posted!');
...
exports.manageNotesData = manageNotesData;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./deleteConfirmationModal":"deleteConfirmationModal.js","./catchAsync":"catchAsync.js"}],"manageUserData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.manageUserData = void 0;
...
var clearPasswordInputFields = function clearPasswordInputFields() {
...
var manageUserData = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(routeType, reqType, data) {
    var axiosOptions, spinnerEl, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            spinnerEl = "#settings-".concat(routeType === 'updateMyPassword' ? 'password' : 'details', "-form__loading-spinner");
          ...
          case 7:
            ...
            if (response.status === 200) {
              if (routeType === 'updateMyPassword') {
                ...
                (0, _alerts.displayAlert)('success', 'Password successfully updated!');
                clearPasswordInputFields();
              } else {
                document.querySelector('#settings-details-form__loading-spinner').style.display = 'none';
                (0, _alerts.displayAlert)('success', 'Data successfully updated!');
              }
            }

            if (response.status === 204) {
              (0, _alerts.displayAlert)('success', 'Account deleted successfully!');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
exports.manageUserData = manageUserData;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"deleteConfirmationModal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.prepareConfirmationModal = exports.displayConfirmationModal = exports.hideConfirmationModal = void 0;

var _manageBookData = require("./manageBookData");

var _manageNotesData = require("./manageNotesData");

var _manageUserData = require("./manageUserData");

var hideConfirmationModal = function hideConfirmationModal() {
  document.querySelector('#confirmation-modal__options').removeEventListener('click', optionsClickHandler);
  var modalEl = document.querySelector('#confirmation-modal');
...
var optionsClickHandler = function optionsClickHandler(e) {
  ...
  if (selectedEl.tagName === 'BUTTON') {
    if (selectedEl.getAttribute('data-value') === 'true') {
      var modalEl = document.querySelector('#confirmation-modal');
      var book = document.querySelector('#full-book');
      var bookId;
      ...
      var target = modalEl.getAttribute('data-target');

      if (target === 'book') {
        (0, _manageBookData.manageBookData)('DELETE', {
          id: bookId
        });
      } else if (target === 'account') {
        (0, _manageUserData.manageUserData)('Delete');
      } else {
        var noteId = modalEl.getAttribute('data-note');
        (0, _manageNotesData.manageNotesData)('DELETE', {
          bookId: bookId,
          noteId: noteId
        });
      }
...
var displayConfirmationModal = function displayConfirmationModal(query) {
  var bookDropdownMenu = document.querySelector('#full-book__dropdown-menu');

  if (bookDropdownMenu) {
    bookDropdownMenu.style.display = 'none';
  }

  document.querySelector('#confirmation-modal__query').innerHTML = "<p>".concat(query, "</p>");
  ...
  document.querySelector('#confirmation-modal__close-button').addEventListener('click', function () {
    hideConfirmationModal();
  });
};

exports.displayConfirmationModal = displayConfirmationModal;

var prepareConfirmationModal = function prepareConfirmationModal(target, noteId) {
  var modalEl = document.querySelector('#confirmation-modal');
...
exports.prepareConfirmationModal = prepareConfirmationModal;
},{"./manageBookData":"manageBookData.js","./manageNotesData":"manageNotesData.js","./manageUserData":"manageUserData.js"}],"managePasswordRecovery.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.managePasswordRecovery = void 0;
...
var managePasswordRecovery = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(routeType, reqType, data) {
    var axiosOptions, spinnerEl, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axiosOptions = {
              url: "/api/v1/users/".concat(routeType, "Password/")
            };
            ...
            spinnerEl = "#".concat(routeType === 'forgot' ? 'forgot-password' : 'password-recovery', "-form__loading-spinner");
            document.querySelector(spinnerEl).style.display = 'inline-block';
            axiosOptions.data = data;
            axiosOptions.method = reqType;
            _context.next = 8;
          ...
          case 8:
            ...
            if (routeType === 'forgot') {
              if (response.status === 200) {
                (0, _alerts.displayAlert)('success', response.data.message);
                document.querySelector(spinnerEl).style.display = 'none';
              }
            } else {
              if (response.status === 200) {
                (0, _alerts.displayAlert)('success', 'Your password has been successfully reset!');
                setTimeout(function () {
                  location.assign('/');
                }, 1500);
              }
...
exports.managePasswordRecovery = managePasswordRecovery;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./catchAsync":"catchAsync.js"}],"manageQuickSearch.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showSearchDropdown = exports.manageQuickSearch = void 0;
...
var manageQuickSearch = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _axios.default)({
              url: "/api/v1/users/search/".concat(query),
              method: 'GET',
              signal: signal
            });
          ...
          case 10:
            ...
            if (!(_context.t0.message && _context.t0.message === 'canceled')) {
              _context.next = 14;
              break;
            }
          ...
          case 14:
            return _context.abrupt("return", showSearchDropdown(false));
  ...
  return function manageQuickSearch(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.manageQuickSearch = manageQuickSearch;

var clearResults = function clearResults() {
  var quickResults = document.querySelector('.search-users__quick-results');
  quickResults.innerHTML = '';
};

var showSearchDropdown = function showSearchDropdown(bool) {
  var searchUsersEl = document.querySelector('#search-users');
...
exports.showSearchDropdown = showSearchDropdown;

var showLoadingSpinner = function showLoadingSpinner(bool) {
  var loadingSpinner = document.querySelector('.search-users__spinner');
...
var addResultElements = function addResultElements(results) {
  var html = '';
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      html += "\n            <a class='search-users__result' href='/users/".concat(result.username, "'>\n                <img class='user-photo search-users__profile-photo' src='/images/users/").concat(result.profilePhoto, "'>\n                <div>\n                    <p class='search-users__username'>").concat(result.username, "</p>\n                    <p class='search-users__books'>").concat(result.books.length, " Book").concat(result.books.length === 1 ? '' : 's', "</p>\n                </div>\n            </a>\n        ");
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
var _signupOrLogin = require("./signupOrLogin");

var _ratingInput = require("./ratingInput");
...
var _managePasswordRecovery = require("./managePasswordRecovery");
...
var logoutListItem = document.querySelector('#logout-list-item');
var ratingInput = document.querySelector('#form__stars');
var fullBook = document.querySelector('#full-book');
var editBookForm = document.querySelector('#edit-book-form');
var userDropdownButton = document.querySelector('#main-nav__user-button');
var settingsDetailsForm = document.querySelector('#settings-details-form');
var settingsPasswordForm = document.querySelector('#settings-password-form');
var settingsDeleteButton = document.querySelector('#settings-delete-button');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var username = document.querySelector('#signup-form__name-field').value;
    var email = document.querySelector('#signup-form__email-field').value;
    var password = document.querySelector('#signup-form__password-field').value;
    var confirmPassword = document.querySelector('#signup-form__confirm-password-field').value;
    (0, _signupOrLogin.signupOrLogin)('signup', {
      username: username,
      email: email,
      password: password,
...
if (passwordRecoveryForm) {
  passwordRecoveryForm.addEventListener('submit', function (e) {
    ...
    var password = document.querySelector('#password-recovery-form__password-field').value;
    var confirmPassword = document.querySelector('#password-recovery-form__confirm-password-field').value;
    (0, _managePasswordRecovery.managePasswordRecovery)('reset', 'PATCH', {
      token: token,
      password: password,
      confirmPassword: confirmPassword
    });
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.querySelector('#forgot-password-form__email-field').value;
    (0, _managePasswordRecovery.managePasswordRecovery)('forgot', 'POST', {
      email: email
    });
  });
}
...
if (settingsDetailsForm) {
  settingsDetailsForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _manageUserData.manageUserData)('updateMe', 'PATCH', formData);
  });
}
...
if (settingsPasswordForm) {
  settingsPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var currentPassword = document.querySelector('#settings-password-form__current-password-field').value;
    var password = document.querySelector('#settings-password-form__password-field').value;
    var confirmPassword = document.querySelector('#settings-password-form__confirm-password-field').value;
    (0, _manageUserData.manageUserData)('updateMyPassword', 'PATCH', {
...
if (settingsDeleteButton) {
  settingsDeleteButton.addEventListener('click', function (e) {
    (0, _deleteConfirmationModal.prepareConfirmationModal)('account');
    (0, _deleteConfirmationModal.displayConfirmationModal)('Are you sure you want to delete your account?');
  });
}

if (userDropdownButton) {
  userDropdownButton.addEventListener('click', function (e) {
    var el = document.querySelector('#main-nav__dropdown');
    var activeClass = 'main-nav__dropdown--active';
...
if (logoutListItem) {
  logoutListItem.addEventListener('click', function () {
    (0, _signupOrLogin.logout)();
  });
}

if (ratingInput) {
  ratingInput.addEventListener('mouseover', _ratingInput.ratingMouseOverHandler);
  ratingInput.addEventListener('mouseleave', _ratingInput.ratingMouseLeaveHandler);
  ratingInput.addEventListener('click', _ratingInput.ratingClickHandler);
}

if (bookForm) {
  bookForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var title = document.querySelector('#book-form__title-field').value;
    var author = document.querySelector('#book-form__author-field').value;
    var selectedStarElement = document.querySelector('.form__star--selected');
    var rating;
    if (selectedStarElement) rating = +selectedStarElement.getAttribute('data-index') + 1;
    var genre = document.querySelector('#book-form__genre-field').value;
    (0, _manageBookData.manageBookData)('POST', {
      title: title,
      author: author,
      rating: rating,
      genre: genre
...
if (editBookForm) {
  editBookForm.addEventListener('submit', function (e) {
    ...
    var title = document.querySelector('#edit-book-form__title-field').value;
    var author = document.querySelector('#edit-book-form__author-field').value;
    var selectedStarElement = document.querySelector('.form__star--selected');
    var rating;
    if (selectedStarElement) rating = +selectedStarElement.getAttribute('data-index') + 1;
    var genre = document.querySelector('#edit-book-form__genre-field').value;
    (0, _manageBookData.manageBookData)('PATCH', {
      id: id,
      title: title,
      author: author,
      rating: rating,
...
window.addEventListener('click', function (e) {
  ...
  if (bookDropdownMenu) {
    if (!bookDropdownMenu.contains(e.target) && !document.querySelector('#full-book__dropdown-button').contains(e.target)) {
      bookDropdownMenu.style.display = 'none';
    }
  }
}); // book page

var attachListenerToNoteDeleteButtons = function attachListenerToNoteDeleteButtons(handler) {
  var noteDeleteButtons = document.querySelectorAll('.full-book__note-delete-button');
  noteDeleteButtons.forEach(function (el) {
    el.addEventListener('click', handler);
  });
};

if (fullBook) {
  var bookDropdownButton = document.querySelector('#full-book__dropdown-button');
  var bookNoteForm = document.querySelector('#full-book__note-form');

  if (bookDropdownButton) {
    bookDropdownButton.addEventListener('click', function (e) {
      if (document.querySelector('#full-book__dropdown-menu').style.display === '' || document.querySelector('#full-book__dropdown-menu').style.display === 'none') {
    ...
    document.querySelector('#full-book__book-delete-button').addEventListener('click', function (e) {
      (0, _deleteConfirmationModal.prepareConfirmationModal)('book');
      (0, _deleteConfirmationModal.displayConfirmationModal)('Are you sure you want to delete the book?');
    });
  }

  if (bookNoteForm) {
    bookNoteForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var note = document.querySelector('#full-book__new-note-body').value;
      var bookId = document.querySelector('#full-book').getAttribute('data-id');
      (0, _manageNotesData.manageNotesData)('POST', {
        note: note,
        bookId: bookId
      });
    });
    attachListenerToNoteDeleteButtons(_manageNotesData.noteDeleteClickHandler);
  }
} // End of book page
// Masonry.js config
...
setTimeout(initializeMasonry, 2000); // End of Masonry.js config

if (searchUsersField) {
  var inputLength = 0;
  searchUsersField.addEventListener('keydown', function (e) {
    inputLength = e.target.value.length;
  });
  searchUsersField.addEventListener('keyup', function (e) {
    if (e.target.value.length !== inputLength) {
      if (e.target.value.length === 0) return (0, _manageQuickSearch.showSearchDropdown)(false);
      console.log(e.target.value);
      (0, _manageQuickSearch.manageQuickSearch)(e.target.value);
    }
  });
}
